...
module.exports = function(b) {
    ...
    _.map([
        ...
        b.fields[input] = function(model, field, errors, attrs) {
            ...
            content += b.components.label(model, field, _.defaults(options.labelAttrs, {
                label: options.label,
                required: options.required,
                before: options.beforeLabel,
                after: options.afterLabel
            }));
    ...
    _.map({
        ...
        b.fields[method] = function(model, field, inputOptions, errors, attrs) {
            ...
            var content = b.components.label(model, field, _.defaults(options.labelAttrs, {
                label: options.label,
                for: null,
                required: options.required,
                before: options.beforeLabel,
